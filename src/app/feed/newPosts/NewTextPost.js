    ...
    render() {
        ...
        return (
            <div className='newPostDiv'>
                ...
                <h6>Post content</h6>
                <input id="textarea1" onChange={this.changeBodyHandler} type="text" value={this.state.newBody} onChange={this.changeBodyHandler} className="materialize-textarea"></input>
